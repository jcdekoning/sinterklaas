...
export default {
  ...
  header: {
    title: "Sinterklaas 2019",
    subheader: "Nederlandse club Oslo - NTC het Noorderlicht"
  },
  intro: {
    title: 'Hoe werkt het inschrijven?',
    description: <><p>Sinterklaas heeft laten weten ook dit jaar naar Noorwegen te komen. Op {longDateEvent} wil hij speciaal de kinderen van de Nederlandse Club Oslo en de Nederlandse school NTC Het Noorderlicht komen bezoeken. Alle kinderen (0-10 jaar) mogen op audiëntie en ontvangen een cadeautje van Sinterklaas.</p>
      <p>
        Via dit formulier kunnen ouders/verzorgers hun kind aanmelden voor het Sinterklaasfeest.</p></>,
    stap1: 'In de eerste stap wordt u om wat algemene gegevens gevraagd. Ook geeft u hier aan hoeveel kinderen (maximaal 5) u wilt inschrijven.',
  ...
  stap1: {
    ...
    gratisLidmaatschap: {
      ...
      description: (<><p>Omdat u een of meerdere kinderen op de NTC Het Noorderlicht heeft, is een lidmaatschap van de Nederlandse Club Oslo geen vereiste om deel te nemen aan het Sinterklaasfeest. De Nederlandse Club Oslo biedt u wel een gratis lidmaatschap aan tot eind 2019. Het lidmaatschap wordt daarna automatisch verlengd.</p><p>Wilt u van dit aanbod gebruik maken?</p></>),
      error: 'Maak een keuze'
    },
    lidmaatschap: {
      label: 'Lidmaatschap Nederlandse Club Oslo',
      descriptionGratis: 'Voor het gratis lidmaatschap tot eind 2019 hebben we enkele extra gegevens nodig.',
      descriptionVerplicht: 'Omdat u geen kinderen heeft op de NTC Het Noorderlicht is een lidmaatschap een vereiste om deel te nemen aan het Sinterklaasfeest. Hiervoor hebben we enkele extra gegevens nodig'
    },
    adres: {
      label: 'Uw adres',
      error: 'Vul uw adres in'
    },
    telefoon: {
    ...
    deelnemers: {
      ...
      description: 'Geef hieronder aan wie er mee komen naar het Sinterklaasfeest.'
    },
    aantalKinderen: {
      ...
      error: {
        ...
        max: 'Er kunnen maximaal 5 kinderen worden ingeschreven. Wilt u meer kinderen aanmelden neem dan contact op via sinterklaas@nederlandsecluboslo.nl'
      }
    },
    aantalPersonen: {
      label: 'Aantal volwassenen (inclusief kinderen boven de 10 jaar)',
      description: 'Per gezin hebben twee personen (volwassenen en kinderen boven de 10 jaar) gratis toegang tot het feest. Voor elke extra persoon boven vragen we een vergoeding.',
      error: {
        required: 'Vul het aantal volwassenen/kinderen boven de 10 jaar in',
        min: 'Minimaal aantal personen moet 1 zijn',
        max: 'Er kunnen maximaal 10 personen mee. Wilt u meer personen meenemen, neem dan contact op via sinterklaas@nederlandsecluboslo.nl'
      }
    }
  },
  stap2: {
  ...
  overzichtEntreegeld: {
    ...
    description: "Hier vindt u een overzicht van de totale kosten voor de inschrijving op basis van de keuzes die u hierboven heeft gemaakt.",
    aantalInschrijvingen: (aantalKinderen: number) => `${aantalKinderen} ${singularOrPlural(aantalKinderen, 'inschrijving', 'inschrijvingen')} x 150 NOK`,
    aantalExtraPersonen: (aantalExtraPersonen: number) => `${aantalExtraPersonen} extra ${singularOrPlural(aantalExtraPersonen, 'persoon', 'personen')} x 50 NOK`,
    lidmaatschap: 'Lidmaatschap t/m eind 2019',
    totaal: 'Totaal',
    valuta: 'NOK'
  },
  success: {
